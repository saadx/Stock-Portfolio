 ...
 * <p>Description: Represents an array implementation of a list. 
 * 					The front of the list is kept at array index 0.
...
public class ArrayList<E> implements ListADT<E>
{
	...
	/**
	 * parameterized constructor -- creates an empty list using the specified
	 * capacity.
	 * 
	...
	/**
	 * removeLast -- removes and returns the last item in this list.
	 * 
	...
	/**
	 * removeFirst -- removes and returns the first element in this list.
	 * 
	...
	/**
	 * remove -- removes and returns the specified element.
	 * 
	...
	/**
	 * first -- returns a reference to the element at the front of this list.
	...
	/**
	 * last -- returns a reference to the element at the rear of this list. The
	...
	/**
	 * find -- returns the array index of the specified element.
	 * 
	 * @param target a reference to the item to be located
	...
	/**
	 * size -- returns a count of the number of items in this list.
	 * 
	...
	/**
	 * expandCapacity -- creates a new array to store the contents of this list
